...
app.controller("PolarAreaCtrl", function ($scope) {
    $scope.labels = ["Angular", "Firebase", "HTML", "CSS", "JavaScripts", "NodeJS", "Bootstrap", "Angular JS", "PHP", "JQuery", "Ionic", "Photoshop", "Git", "ChartsJS", "Wordpress", "mySQL", "RESTful"];
    $scope.data = [50, 40, 90, 90, 70, 60, 100, 75, 35, 65, 55, 75, 85, 50, 90, 80, 75];
    $scope.options = {
        legend: {
            display: true,
